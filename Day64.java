...
Input: The first line contains an integer T denoting the number of feedbacks. Each of the next T lines contains a string composed of only '0' and '1'.
Output: For every test case, print in a single line Good or Bad as per the Amit's method of classification.
